...
class LangZH(output: PackOutput) : LanguageProvider(output, ExtendedAEPlusClient.MODID, "zh_cn") {
    override fun addTranslations() {
        ...
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.tooltip)
            ...
            add("key.extendedae_plus_client.alias_add", "添加别名")
            add("key.extendedae_plus_client.alias_remove", "删除别名")
            add("tooltip.extendedae_plus_client.alias_add", "为选中的供应器添加别名")
            add("tooltip.extendedae_plus_client.alias_remove", "删除选中的供应器的别名")
            .branch("no_selection", "§e未选择任何供应器")
